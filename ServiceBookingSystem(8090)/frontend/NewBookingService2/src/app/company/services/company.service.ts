...
export class CompanyService {
  ...
  getAdsById(adId : any): Observable<any> {
  ...
  updateAd(adId :any , adDto:any): Observable<any>{
    ...
    return this.http.post(BASIC_URL + `api/company/ad/${adId}` , adDto , {
      headers : this.createAuthorizationHeader()
    })
  }
  ...
  getAllAdBookings() : Observable<any> {
    ...
    return this.http.get(BASIC_URL + `api/company/${companyId}`, {
      headers : this.createAuthorizationHeader()
    })
  ...
  changeBookingStatus(bookingId : number , status : string){
    ...
    return this.http.get(BASIC_URL + `api/company/${bookingId}/${status}` , {
      headers : this.createAuthorizationHeader()
    })
