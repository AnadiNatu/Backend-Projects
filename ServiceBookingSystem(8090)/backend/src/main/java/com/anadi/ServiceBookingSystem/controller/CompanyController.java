...
import com.anadi.ServiceBookingSystem.services.company.CompanyService;
...
public class CompanyController {
    ...
    public ResponseEntity<?> postAd(@PathVariable Long userId , @ModelAttribute AdsDto adsDto) throws IOException {
