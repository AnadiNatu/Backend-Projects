...
export class CompanyService {
  ...
  postAd(adDto:any) : Observable<any> {
    ...
    return this.http.post(BASIC_URL + ` api/company/api/${userId}` , adDto , {
  ...
  updateAd(adId : any , adsDto : any) : Observable<any> {

    return this.http.put(BASIC_URL + `api/company/ad/${adId}` , adsDto ,{
      headers : this.createAuthorizationHeader()
    })
  }
